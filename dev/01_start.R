...
golem::fill_desc(
  pkg_name = "shiny.template", # The Name of the package containing the App 
  pkg_title = "PKG_TITLE", # The Title of the package containing the App 
  pkg_description = "PKG_DESC.", # The Description of the package containing the App 
  author_first_name = "Jan", # Your First Name
  author_last_name = "Lieb",  # Your Last Name
  author_email = "liebnitzky@gmail.com",      # Your Email
...
usethis::use_data_raw( name = "versiegelung", open = FALSE ) # Change "my_dataset"
